...
/**
 * Apple touch icon -- same solid-emerald-background, white-cutout mark
 * treatment as icon.tsx, but at a size that can afford the full 5-node
 * graph (LogoMark's inverted variant) instead of the 3-dot simplification.
 */
